...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    private EditText mUserPhone, mUserMail, mUserVK, mUserBio, mUserGit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUserBio = (EditText) findViewById(R.id.about_EditText);
    ...
    private void setupDrawer() {
        ...
        setupDrawerHeader(navigationView, BitmapFactory.decodeResource(getResources(),
                R.drawable.avatar), "Татаринов Михаил", "mujui@yandex.ru");
